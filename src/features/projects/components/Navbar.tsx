...
const Navbar = ({ projectId }: { projectId: Id<"projects"> }) => {
  ...
  const handleSubmitRename = () => {
    ...
    if (!trimmedRename || trimmedRename === project?.name) return;

    renameProject({ id: projectId, name: trimmedRename });
  };
            ...
            <BreadcrumbItem>
              {isRenaming ? (
                ...
                <BreadcrumbPage
                  ...
                  className="text-sm cursoro-pointer hover:text-primary font-medium max-w-40 truncate"
                >
